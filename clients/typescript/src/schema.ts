...
export interface paths {
  ...
  "/subscription/{id}/download": {
     ...
     */
    get: operations["forrit_server.dispatcher.api.list_downloads"];
  };
}
...
export interface operations {
  ...
  "forrit_server.dispatcher.api.new_download": {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["forrit_core.model.WithId<forrit_core.model.Download>"] | null;
        };
      };
      /** @description The requested resource could not be found. */
      404: {
   ...
   * @description List all downloads generated by a subscription
   */
  "forrit_server.dispatcher.api.list_downloads": {
    parameters: {
      query?: {
        /** @description Number of items in a page */
        per_page?: number;
